...
/**
 * Lightweight microbenchmark that compares the AoS statevector kernels against a split-buffer
 * reference implementation. Designed for manual execution:
 *
 * <pre>
 ...
 * </pre>
 *
 * The harness prints timing information and the maximum absolute deviation between the two paths.
 */
public final class StatevectorKernelMicrobenchmark {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf(Locale.US,
                ...
                aoS.nanos() / 1_000_000.0,
                split.nanos() / 1_000_000.0,
                ratio,
                maxDiff);
    }
    ...
    private static void applySingleGateSplit(double[] real, double[] imag, GateSpec gate) {
        ...
        for (int base = 0; base < dimension; base += period) {
            for (int offset = 0; offset < stride; offset++) {
                ...
                double new0r = gate.g00r() * a0r - gate.g00i() * a0i
                        + gate.g01r() * a1r - gate.g01i() * a1i;
                double new0i = gate.g00r() * a0i + gate.g00i() * a0r
                        + gate.g01r() * a1i + gate.g01i() * a1r;
                double new1r = gate.g10r() * a0r - gate.g10i() * a0i
                        + gate.g11r() * a1r - gate.g11i() * a1i;
                double new1i = gate.g10r() * a0i + gate.g10i() * a0r
                        + gate.g11r() * a1i + gate.g11i() * a1r;
    ...
    private record GateSpec(int target,
        ...
        static GateSpec fromGate(int target, SingleQubitGate gate) {
            return new GateSpec(
                    target,
                    gate.element(0, 0).real(), gate.element(0, 0).imag(),
                    gate.element(0, 1).real(), gate.element(0, 1).imag(),
                    gate.element(1, 0).real(), gate.element(1, 0).imag(),
