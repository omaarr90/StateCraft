...
public final class StabilizerEngine implements SimulatorEngine {
    ...
    public SimulationResult simulate(SimulationRequest request) {
        ...
        if (request.returnFinalState() && qubitCount > MAX_FINAL_STATE_QUBITS) {
            throw new UnsupportedOperationException(
                    "stabilizer engine cannot materialize amplitudes above "
    ...
    private static StabilizerAmplitudeMirror createAmplitudeMirror(
    ...
    private static void applyOperation(
            ...
            StabilizerAmplitudeMirror mirror,
    ...
    private static void applyMultiControl(
            StabilizerTableau tableau,
            StabilizerAmplitudeMirror mirror,
    ...
    private static int sampleOutcome(
            StabilizerTableau source,
            int[] measuredQubits,
            SplittableRandom rng) {
    ...
    private static String sampleBitstringOutcome(
            StabilizerTableau source,
            int[] measuredQubits,
            SplittableRandom rng) {
        StabilizerTableau tableau = source.copy();
