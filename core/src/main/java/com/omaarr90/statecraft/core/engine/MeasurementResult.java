 ...
 */
public sealed interface MeasurementResult permits MeasurementResult.Histogram,
        MeasurementResult.Samples,
        MeasurementResult.BitstringHistogram,
        MeasurementResult.BitstringSamples {
     ...
     */
    record BitstringHistogram(int[] measuredQubits, int shots, Map<String, Integer> counts) implements MeasurementResult {
