...
/**
 * Configuration describing how a simulation should perform measurement sampling.
 */
public record MeasurementInstruction(
        int shots,
        Optional<int[]> measuredQubits,
        OptionalLong seed,
        Mode mode) {
    ...
    public MeasurementInstruction {
        ...
        measuredQubits = measuredQubits == null ? Optional.empty() : measuredQubits.map(MeasurementInstruction::normalizeQubits);
