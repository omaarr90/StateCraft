...
public record QuantumCircuit(int qubitCount, List<QuantumCircuit.Operation> operations) {
    ...
    public QuantumCircuit append(SingleQubitGate gate, int targetQubit) {
        Operation.SingleGateOperation operation =
    ...
    public QuantumCircuit append(CnotGate gate, int controlQubit, int targetQubit) {
        Operation.CnotOperation operation = new Operation.CnotOperation(
    ...
    public QuantumCircuit appendTwoQubitUnitary(ComplexNumber[] matrix, int firstQubit, int secondQubit) {
        Operation.TwoQubitGateOperation operation =
                new Operation.TwoQubitGateOperation(copyMatrix(Objects.requireNonNull(matrix, "matrix")),
                        firstQubit, secondQubit);
        return appendOperation(operation);
    }

    public QuantumCircuit appendDiagonalTwoQubit(ComplexNumber[] diagonal, int firstQubit, int secondQubit) {
        Operation.TwoQubitDiagonalOperation operation =
                new Operation.TwoQubitDiagonalOperation(copyDiagonal(
                        Objects.requireNonNull(diagonal, "diagonal")), firstQubit, secondQubit);
        return appendOperation(operation);
    }
    ...
    private ComplexNumber multiplyRow(ComplexNumber[] matrix, int row,
            ComplexNumber a00, ComplexNumber a01, ComplexNumber a10, ComplexNumber a11) {
        int base = row << 2;
    ...
    public sealed interface Operation permits Operation.SingleGateOperation,
            Operation.CnotOperation,
            Operation.TwoQubitGateOperation,
            Operation.TwoQubitDiagonalOperation,
            Operation.SwapOperation,
            Operation.MultiControlOperation,
        ...
        record TwoQubitDiagonalOperation(ComplexNumber[] diagonal, int firstQubit, int secondQubit)
