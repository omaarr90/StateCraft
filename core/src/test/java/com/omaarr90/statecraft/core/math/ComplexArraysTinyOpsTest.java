...
public class ComplexArraysTinyOpsTest {
	...
	void exceptional_nullsAndSizesAndBounds() {
		...
		assertThrows(NullPointerException.class,
				() -> ComplexArrays.mul(null, 0, new double[2], 0, new double[2], 0, 1));
		assertThrows(NullPointerException.class,
				() -> ComplexArrays.mul(new double[2], 0, null, 0, new double[2], 0, 1));
		assertThrows(NullPointerException.class,
				() -> ComplexArrays.mul(new double[2], 0, new double[2], 0, null, 0, 1));

		// nC < 0
		assertThrows(IllegalArgumentException.class, () -> ComplexArrays.scal(new double[2], 0, -1, 1, 0));
		assertThrows(IllegalArgumentException.class,
				() -> ComplexArrays.axpy(1, 0, new double[2], 0, new double[2], 0, -1));
		assertThrows(IllegalArgumentException.class,
				() -> ComplexArrays.mul(new double[2], 0, new double[2], 0, new double[2], 0, -1));
	...
	void mul_illegalAlias_outAliasesBothButDifferentSlices_throws() {
		...
		assertThrows(IllegalArgumentException.class, () -> ComplexArrays.mul(a, 0, a, 1, a, 2, 1));
	}
