...
class MeasurementResultTest {
	...
	void bitstringHistogramStoresCounts() {
		MeasurementResult.BitstringHistogram histogram = new MeasurementResult.BitstringHistogram(new int[]{0, 32, 63},
				3, Map.of("000", 1, "101", 2));
	...
	void bitstringSamplesValidateWidth() {
		assertThrows(IllegalArgumentException.class,
				() -> new MeasurementResult.BitstringSamples(new int[]{0, 1}, 1, List.of("101")));
	}
}
